...
import mockIngredients from "@/app/dummyData/mockData";
import { useRef } from "react";
import CustomScrollbar from "../ui/CustomScrollbar";

const DASHBOARD_DATA = mockIngredients.slice(0, 8).map((ing, idx) => ({
  itemName: ing.name,
  forecastQuantity: 10,
  approvedQuantity: 12,
  preparedQuantity: 18,
        ...
        <Card className="overflow-auto rounded-xl p-0">
          <CardHeader className=" bg-[#edeff6] overflow-auto p-0 rounded-xl gap-0">
            <Tabs
              ...
              className="rounded-xl bg-[#edeff6] p-4 "
            >
